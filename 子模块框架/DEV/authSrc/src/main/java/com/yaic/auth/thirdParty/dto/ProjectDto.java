...
public class ProjectDto extends BaseDto implements Serializable {
	...
	public ProjectDto(int projectId, String projectCode, String projectName, int accountId, int authId,
    ...
    public String toString () {
        return "ProjectDto [projectId=" + projectId + ", projectCode=" + projectCode + ", projectName=" + projectName
