...
public class DataSourceDto extends BaseDto implements Serializable {
	...
	public DataSourceDto(int dataSourceId, String dataSource, String sourceName, String appId, int authId,
    ...
    public String toString () {
        return "DataSourceDto [dataSourceId=" + dataSourceId + ", dataSource=" + dataSource + ", sourceName="
